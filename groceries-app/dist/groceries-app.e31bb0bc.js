...
},{"@firebase/database":"../node_modules/@firebase/database/dist/index.esm2017.js"}],"index.js":[function(require,module,exports) {
"use strict";

var _app = require("firebase/app");
var _database = require("firebase/database");
var url = "https://mobile-app-df74b-default-rtdb.firebaseio.com/";
var appSettings = {
  databaseURL: url
};
var app = (0, _app.initializeApp)(appSettings);
var database = (0, _database.getDatabase)(app);
var shoppingListInDB = (0, _database.ref)(database, "shoppingList");
...
function appendItemToShoppingListEl(item) {
  ...
  newEl.addEventListener("dblclick", function () {
    var exactLocationOfItemInDB = (0, _database.ref)(database, "shoppingList/".concat(itemID));
    (0, _database.remove)(exactLocationOfItemInDB);
  });
...
//# sourceMappingURL=/groceries-app.e31bb0bc.js.map